...
class MockController:
    ...
    async def test_command(self, random_arg: str):
        ...
        """
        self.called = True
        self.random_argument = random_arg
...
async def test_dispatch_simple_command():
    ...
    assert controller_instance.random_argument == "hello"
...
async def test_dispatch_type_conversion():
    ...
    # 5 + 10 = 15
    assert controller_instance.random_argument == 15
